...
class MWC_Gift_Certificates_Frontend {
	 ...
	 *
	 * @since 3.0.0
	 * @param mixed|WP_Post[] $posts results from the query -- usually an array of \WP_Post objects
	 * @return mixed|WP_Post results from the query -- usually an array of \WP_Post objects
	 */
