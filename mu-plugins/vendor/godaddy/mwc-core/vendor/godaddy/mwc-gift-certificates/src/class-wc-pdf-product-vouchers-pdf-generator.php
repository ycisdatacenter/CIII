...
class MWC_Gift_Certificates_PDF_Generator {
	...
	public static function generate_voucher_pdf( WC_Voucher $voucher, $save = true ) {
		...
		/**
		 * Filters the sslverify value for the voucher HTML GET request.
		 *
		 * @since 3.12.3
		 *
		 * @param bool $sslverify true if SSL verification should be enabled (default: true)
		 */
		$sslverify = (bool) apply_filters( 'wc_pdf_product_vouchers_render_voucher_html_sslverify', true );
