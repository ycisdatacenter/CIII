...
class MWC_Gift_Certificates_Loader {
	...
	public const FRAMEWORK_VERSION = '5.12.1';

	/** the plugin name, for displaying notices */
	public const PLUGIN_NAME = 'Gift Certificates';


	/** @var MWC_Gift_Certificates_Loader|null single instance of this class */
	protected static ?MWC_Gift_Certificates_Loader $instance = null;
	 ...
	 */
	public static function instance() : MWC_Gift_Certificates_Loader
	{
