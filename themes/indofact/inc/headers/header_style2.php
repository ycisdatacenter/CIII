        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 display-block ">   
			...
			?>
              <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo">
				<img src="<?php echo esc_url( $tmc_option['logo_header_two']['url'] ); ?>" class="img-responsive" alt="<?php bloginfo( 'name' ); ?>">
			  </a>       
			<?php 
				else:
			...
			?> 
				 <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo">
					<img src="<?php echo esc_url( $logo ); ?>" class="img-responsive" alt="<?php bloginfo( 'name' ); ?>">
			  </a>     
			<?php endif; ?>
		</div>
            <div class="col-lg-8 col-md-9 col-sm-12 col-xs-12 pull-right">               
                <ul class="header-info">
					<?php if(isset($tmc_option['header_add_line_one']) && $tmc_option['header_add_line_one'] != '' || isset($tmc_option['header_add_line_two']) && $tmc_option['header_add_line_two'] != '' ):?>
						<li class="<?php echo esc_attr($tmc_option['header_add_icon']); ?>"><strong><?php echo esc_attr($tmc_option['header_add_line_one']); ?></strong><br/><?php echo esc_attr($tmc_option['header_add_line_two']); ?></li>
					<?php endif; ?>
    ...
    <nav id="main-navigation-wrapper" class="navbar navbar-default navbar2-wrap <?php echo esc_attr($stickyclass); ?>">
      <div class="container">
        <div class="navbar-header">
          <div class="logo-menu">
			<?php
				if (isset($tmc_option['logo_mobile_two']['url'] )):
			?>
              <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo">
				<img src="<?php echo esc_url( $tmc_option['logo_mobile_two']['url'] ); ?>" class="img-responsive" alt="<?php bloginfo( 'name' ); ?>">
			  </a>       
			<?php 
				else: 
				$logo = get_template_directory_uri() .'/assets/images/tmp/white-logo.png';
			?> 
				 <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo">
					<img src="<?php echo esc_url( $logo ); ?>" class="img-responsive" alt="<?php bloginfo( 'name' ); ?>">
			  </a>   
